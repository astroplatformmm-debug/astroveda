              ...
              {[
                {
                  ...
                  metal: "Gold",
                  day: "Sunday",
                  benefits: ["Leadership & authority", "Self-confidence", "Career growth"],
                },
                {
                  planet: "Moon (Chandra)",
                  stone: "Pearl",
                ...
                },
                {
                  ...
                  metal: "Gold / Copper",
                  day: "Tuesday",
                  benefits: ["Courage & energy", "Health & vitality", "Removes obstacles"],
                },
                {
                  planet: "Mercury (Budh)",
                  stone: "Emerald",
                  ...
                  metal: "Gold / Silver",
                  day: "Wednesday",
                  benefits: ["Intelligence & memory", "Business success", "Communication"],
                },
                {
                  planet: "Jupiter (Guru)",
                  ...
                  metal: "Gold",
                  day: "Thursday",
                  benefits: ["Wisdom & knowledge", "Wealth & prosperity", "Marriage luck"],
                },
                {
                  planet: "Venus (Shukra)",
                  stone: "Diamond",
                  ...
                  metal: "Gold / Platinum",
                  day: "Friday",
                  benefits: ["Love & relationships", "Luxury & comfort", "Artistic talent"],
                },
                {
                  planet: "Saturn (Shani)",
                  stone: "Blue Sapphire",
                  ...
                  metal: "Gold / Silver",
                  day: "Saturday",
                  benefits: ["Discipline & focus", "Career stability", "Removes delays"],
                },
                {
                  ...
                  day: "Saturday",
                  benefits: ["Ambition & success", "Removes confusion", "Foreign gains"],
                },
                {
                  ...
                  metal: "Silver / Panchdhatu",
                  day: "Tuesday",
                  benefits: ["Spiritual growth", "Moksha & liberation", "Psychic insight"],
                },
              ].map((g) => (
                <div key={g.planet} className={`rounded-xl border ${g.border} ${g.bg} p-4 flex flex-col gap-3`}>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {[
                      { label: "Finger", val: g.finger },
                      { label: "Metal", val: g.metal },
                      { label: "Day", val: g.day },
                    ].map((d) => (
